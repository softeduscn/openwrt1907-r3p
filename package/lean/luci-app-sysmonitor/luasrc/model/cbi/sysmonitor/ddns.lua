...
s.description = '<table><style>.button1 {-webkit-transition-duration: 0.4s;transition-duration: 0.4s;padding: 1px 3px;text-align: center;background-color: white;color: black;border: 2px solid #4CAF50;border-radius:5px;}.button1:hover {background-color: #4CAF50;color: white;}.button1 {font-size: 11px;}</style><tr><td title="Goto Hostnames"><button class="button1"><a href="/cgi-bin/luci/admin/sys/sysmonitor/sys?sys=UpdateDDNS&redir=ddns">' .. translate("UpdateDDNS") .. '</a></button></td></tr></table>'
end
s.addremove = true
s.anonymous = true
s.sortable = true
